...
internal static class WorkTimeEndpoints
{
    ...
    private static async Task<Page<WorkTime>> GetWorkTimesAsync(WorklogManagementContext context, string sortBy = "Id", int pageSize = 0, int pageIndex = 0, string? filter = null)
    {
